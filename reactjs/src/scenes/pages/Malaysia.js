...
class Malaysia extends Component {
    ...
    componentWillMount() {
        const apiUrl = 'http://localhost:8000/api/auth/get-country-event/Malaysia';
        fetch(apiUrl)
          .then(res => res.json())
          .then(
            (result) => {
        ...
        return (
            <>
                ...
                <div className="country-page-container">
                    ...
                    <center>
                    <p className="event-title">MALAYSIA <img src="/Malaysia.png" style={{height: "45px", paddingBottom: "5px"}} /></p>
                    </center>
