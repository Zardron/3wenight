...
class Thailand extends Component {
    ...
    componentWillMount() {
        const apiUrl = 'http://localhost:8000/api/auth/get-country-event/Thailand';
        fetch(apiUrl)
          .then(res => res.json())
          .then(
            (result) => {
        ...
        return (
            <>
                ...
                <div className="country-page-container">
                    ...
                    <center>
                    <p className="event-title">THAILAND <img src="/Thailand.png" style={{height: "45px", paddingBottom: "5px"}} /></p>
                    </center>
